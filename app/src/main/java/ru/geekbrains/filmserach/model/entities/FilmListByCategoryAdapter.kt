...
class FilmListByCategoryAdapter(private val list: List<Film>) :
    ...
    override fun onCreateViewHolder(
            parent: ViewGroup,
            viewType: Int) :
            FilmListByCategoryAdapter.FilmListByCategoryViewHolder {
    ...
    override fun onBindViewHolder(
            holder: FilmListByCategoryAdapter.FilmListByCategoryViewHolder,
            position: Int) {
        val item = list[position]

        holder.categoryNameView.text = item.title
        //holder.filmListView.text = item.originalTitle
    }
